        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <a href="<?= base_url('welcome') ?>"> <img src="" width="150" class=" mb-5 mt-2"></a>
                        <h4 class="text-dark font-weight-normal">Selamat datang di <span class="font-weight-bold">SMA APA AJA</span>
                        </h4>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/ss.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Made with <span class="text-danger"> &#10084;</span> by <a class="text-light bb" target="_blank" href="#">Agung Maulana</a> - Image by <a class="text-light bb" target="_blank" href="#">Unsplash</a>
                        </div>
                    </div>
                </div>
            </div>
