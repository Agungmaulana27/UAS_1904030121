    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang SMA APA AJA</h4>
                <p>
                    Web Edukasi Open Source yang dibuat oleh Agung Maulana. SMA APA AJA adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. Web ini dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja.
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                <a href="#" target="_blank">Colorlib</a> <br> Learnify is made with <span class="text-danger"> &#10084;</span> by <a href="#">Agung Maulana </a>
            </p>
