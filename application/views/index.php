    ...
    <div class="banner_inner d-flex align-items-center">
        ...
        <div class="container">
            <div class="banner_content text-center">
                <h3 data-aos="fade-up" data-aos-duration="1600">SMA APA AJA <br /> NEGERI 12</h3>
                <p data-aos="fade-up" data-aos-duration="1900">Jl. Salembaran Kampung Melayu Timur Rt. 001/022 Kec. Teluknaga Banten 15510 </p>
...
<section class="courses_area p_40">
    <div class="container">
        <div class="main_title">
            <h2 data-aos="fade-up" data-aos-duration="1600">Pelajaran Yang Tersedia</h2>
                        ...
                        <div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-user"></i>Guru Matematika SMA APA AJA</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i> Guru IPA SMA APA AJA</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i> Guru English SMA APA AJA</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i> Guru Indonesia SMA APA AJA</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="course_item" data-aos="fade-left" data-aos-duration="1800">
                    ...
                    <div class="hover_text">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                            <li><a href="#"><i class="lnr lnr-user"></i> Guru Agama SMA APA AJA</a></li>
                        </ul>
                    </div>
                </div>
            </div>
